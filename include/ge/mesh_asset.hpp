 ...
 * {
 *   "asset_type": "mesh", 
 *   "obj_data": "/path/to/model.obj" # if this is omitted, then it defaults to ./model.obj TODO: add more file types
 * }
 * 
 */
...
public:
	...
	mesh_asset(asset_manager& manager, const std::string& arg_name,
