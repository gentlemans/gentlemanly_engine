...
sdl_viewport::sdl_viewport(ge::window_backend::sdl_window* window_arg)
	:m_window{window_arg}
{
...
void sdl_viewport::render_actor(ge::actor* actor)
{
	...
	glm::mat3 projection = glm::ortho2d( -aspect * current_camera->vertical_units, aspect * current_camera->vertical_units, -current_camera->vertical_units, current_camera->vertical_units);
...
void sdl_viewport::set_camera(ge::camera* camera)
{
	current_camera = camera;
}

ge::camera* sdl_viewport::get_camera() const
{
