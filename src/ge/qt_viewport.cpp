...
bool qt_viewport::event(QEvent* event)
{
	switch (event->type())
	{
		case QEvent::Type::MouseButtonPress:
		{
			...
			{
				case Qt::LeftButton:
					events.push_back(input_mouse_button{mouse_button::e_left_button, true});
					break;
				case Qt::RightButton:
					events.push_back(input_mouse_button{mouse_button::e_right_button, true});
					break;
				case Qt::MiddleButton:
					events.push_back(input_mouse_button{mouse_button::e_middle_button, true});
					break;
			}
			return true;
		}
		...
		case QEvent::Type::MouseButtonRelease:
		{
			...
			{
				case Qt::LeftButton:
					events.push_back(input_mouse_button{mouse_button::e_left_button, false});
					break;
				case Qt::RightButton:
					events.push_back(input_mouse_button{mouse_button::e_right_button, false});
					break;
				case Qt::MiddleButton:
					events.push_back(input_mouse_button{mouse_button::e_middle_button, false});
					break;
			}
			return true;
		}
